    ...
    internal class Program
    {
        ...
        public static class Test
        {
            public static bool TestRezerwacji(Stadion stadion)
            {
                ...
                bool wynik2 = stadion.ZarezerwujMiejsce(2, 5, 10m);
                if (wynik2)
                {
            ...
            public static bool TestSalda(Stadion stadion)
            {
                ...
                bool wynik2 = stadion.ZarezerwujMiejsce(4, 5, 10m);
                if (wynik2)
                {
        ...
        {
            Stadion stadion = new Stadion(10, 20, 50m);

            while (true)
            {
                Console.Clear();
                Console.WriteLine("Menu Główne:");
                Console.WriteLine("1. Zarezerwuj miejsce (koszt: 10 zł)");
                ...
                switch (menu)
                {
                    case 1:
                        ...
                        stadion.ZarezerwujMiejsce(rzad, miejsce, 10m);
